...
const styles: Record<string, React.CSSProperties> = {
  ...
  input:     { height: 40, width: 120, borderRadius: 8, border: '1.5px solid #6366F1', paddingInline: 12, fontSize: 15, outline: 'none' },
  ...
  saveBtn:   { height: 36, paddingInline: 16, borderRadius: 8, border: 'none', background: '#6366F1', color: '#fff', fontSize: 13, cursor: 'pointer', fontWeight: 600 },
